...
function spotifySong(){
	spotify.search({ type: 'track', query: request }, function(err, data) {
	    if ( err ) {
	    	...
	    	console.log("Line 121 Artist: " + data.tracks.items[0].artists[0].name);
			console.log("Line 122 Song Name: " + data.tracks.items[0].name);
            console.log("Line 123 Album: " + data.tracks.items[0].name);
            console.log("Line 124 Preview Link: " + data.tracks.items[0].artists[0].external_urls.spotify);
		}
